// import { CrudFilters, CrudSorting, LiveEvent, LiveProvider } from '@refinedev/core';
...
//     // 客户端：使用 Socket.IO
//     if (!socket) {
//       socket = io(`https://refine-jet.vercel.app:${SOCKET_PORT}`, socketConfig);
...
//   } else {
//     // 服务器端：使用 HTTP 请求
//     fetch(`https://refine-jet.vercel.app:${SOCKET_PORT}/api/publish`, {
//       method: 'POST',
//       headers: {
...
// // 创建 socket 管理器实例
// const socketManager = new SocketManager(`https://refine-jet.vercel.app:${SOCKET_PORT}`);

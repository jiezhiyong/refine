import{j as i}from"./jsx-runtime-C-_spy54.js";import{M as ln,I as dn,A as un,F as _n,K as hn,L as fn,N as mn,a as pn,i as gn}from"./index-hdkCHUwo.js";import{B as we,c as V,S as bn}from"./button-8zOaFnqZ.js";import{L as Ie,f as Pe,d as Qe,g as At}from"./components-CzmxjdGq.js";import{t as K,c as xn}from"./i18next-BaiEmIpz.js";import{r as $e}from"./index-aGVi9Z7h.js";import{t as Ht,Y as vn,Z as It,f as yn,_ as wn,G as Cn,u as Sn,$ as kn,a0 as jn,a1 as En,a2 as Nn,a3 as Ln,a4 as Mn,a5 as Tn,a6 as Fn,a7 as Dn,S as Rn}from"./lucide-icons-Cs_6wGxK.js";import{L as lt,D as Pt,a as Bt,b as zt,c as Ut,d as Ve,e as $n,f as Ae,g as An}from"./index-CQpobmnh.js";import{A as dt,a as ut,b as _t}from"./avatar-BbKjKTaI.js";import{u as Yt,d as Be,e as le,f as de,b as Xt,i as Hn,C as In,j as Pn,k as Bn,m as zn,n as Un,o as Yn,c as Xn,S as Ot,p as On,a as qn,l as Gn,q as Vn,r as Wn,s as Zn,t as Kn}from"./collapsible-DP1HK-Rw.js";import{g as ht}from"./capitalize-first-letter-B7Vzw64t.js";import{D as Jn}from"./dynamic-icon-B2CUf8En.js";import{a as Qn}from"./base-url-B9uMRsbQ.js";import{a as ft}from"./roles-BPHs5haX.js";import{b as xe,l as er}from"./index-BP0AYnXF.js";import{u as tr}from"./500-CvlJQvp0.js";import{i as nr}from"./isBrowser-BS1Xf4tW.js";import{d as rr,g as qt,a as et,b as mt,l as Le,c as or,e as ar,G as ir,f as sr}from"./node-_8Bt17R8.js";import{S as Gt}from"./separator-DzvNw-3x.js";import{B as cr}from"./badge-DliJJe0J.js";import{O as lr}from"./index-DN0hhrBY.js";function dr(e,t={},n=et()){const{message:r,name:a,email:o,url:l,source:u,associatedEventId:d,tags:c}=e,h={contexts:{feedback:rr({contact_email:o,name:a,message:r,url:l,source:u,associated_event_id:d})},type:"feedback",level:"info",tags:c},s=n&&n.getClient()||qt();return s&&s.emit("beforeSendFeedback",h,t),n.captureEvent(h,t)}const G=ir,S=G.document,ve=G.navigator,Vt="Report a Bug",ur="Cancel",_r="Send Bug Report",hr="Confirm",fr="Report a Bug",mr="your.email@example.org",pr="Email",gr="What's the bug? What did you expect?",br="Description",xr="Your Name",vr="Name",yr="Thank you for your report!",wr="(required)",Cr="Add a screenshot",Sr="Remove screenshot",kr="widget",jr="api",Er=5e3,Nr=(e,t={includeReplay:!0})=>{if(!e.message)throw new Error("Unable to submit feedback with empty message");const n=qt();if(!n)throw new Error("No client setup, cannot send feedback.");e.tags&&Object.keys(e.tags).length&&et().setTags(e.tags);const r=dr({source:jr,url:sr(),...e},t);return new Promise((a,o)=>{const l=setTimeout(()=>o("Unable to determine if Feedback was correctly sent."),5e3),u=n.on("afterSendEvent",(d,c)=>{if(d.event_id===r)return clearTimeout(l),u(),c&&typeof c.statusCode=="number"&&c.statusCode>=200&&c.statusCode<300?a(r):c&&typeof c.statusCode=="number"&&c.statusCode===0?o("Unable to send Feedback. This is because of network issues, or because you are using an ad-blocker."):c&&typeof c.statusCode=="number"&&c.statusCode===403?o("Unable to send Feedback. This could be because this domain is not in your list of allowed domains."):o("Unable to send Feedback. This could be because of network issues, or because you are using an ad-blocker")})})},Me=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__;function Lr(){return!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(ve.userAgent)||/Macintosh/i.test(ve.userAgent)&&ve.maxTouchPoints&&ve.maxTouchPoints>1||!isSecureContext)}function je(e,t){return{...e,...t,tags:{...e.tags,...t.tags},onFormOpen:()=>{t.onFormOpen&&t.onFormOpen(),e.onFormOpen&&e.onFormOpen()},onFormClose:()=>{t.onFormClose&&t.onFormClose(),e.onFormClose&&e.onFormClose()},onSubmitSuccess:n=>{t.onSubmitSuccess&&t.onSubmitSuccess(n),e.onSubmitSuccess&&e.onSubmitSuccess(n)},onSubmitError:n=>{t.onSubmitError&&t.onSubmitError(n),e.onSubmitError&&e.onSubmitError(n)},onFormSubmitted:()=>{t.onFormSubmitted&&t.onFormSubmitted(),e.onFormSubmitted&&e.onFormSubmitted()},themeDark:{...e.themeDark,...t.themeDark},themeLight:{...e.themeLight,...t.themeLight}}}function Mr(e){const t=S.createElement("style");return t.textContent=`
.widget__actor {
  position: fixed;
  z-index: var(--z-index);
...
${_o}
${ho}
`,e&&t.setAttribute("nonce",e),t}function mo(){const e=et().getUser(),t=or().getUser(),n=ar().getUser();return e&&Object.keys(e).length?e:t&&Object.keys(t).length?t:n}const po=()=>({name:"FeedbackModal",setupOnce(){},createDialog:({options:e,screenshotIntegration:t,sendFeedback:n,shadow:r})=>{const a=r,o=e.useSentryUser,l=mo(),u=S.createElement("div"),d=fo(e.styleNonce);let c="";const h={get el(){return u},appendToDom(){!a.contains(d)&&!a.contains(u)&&(a.appendChild(d),a.appendChild(u))},removeFromDom(){a.removeChild(u),a.removeChild(d),S.body.style.overflow=c},open(){f(!0),e.onFormOpen&&e.onFormOpen(),c=S.body.style.overflow,S.body.style.overflow="hidden"},close(){f(!1),S.body.style.overflow=c}},s=t&&t.createInput({h:b,hooks:Qr,dialog:h,options:e}),f=_=>{Yr(b(so,{options:e,screenshotInput:s,showName:e.showName||e.isNameRequired,showEmail:e.showEmail||e.isEmailRequired,defaultName:o&&l&&l[o.name]||"",defaultEmail:o&&l&&l[o.email]||"",onFormClose:()=>{f(!1),e.onFormClose&&e.onFormClose()},onSubmit:n,onSubmitSuccess:g=>{f(!1),e.onSubmitSuccess&&e.onSubmitSuccess(g)},onSubmitError:g=>{e.onSubmitError&&e.onSubmitError(g)},onFormSubmitted:()=>{e.onFormSubmitted&&e.onFormSubmitted()},open:_}),u)};return h}});function go({h:e}){return function({top:n,left:r,corner:a,onGrabButton:o}){return e("button",{class:`editor__crop-corner editor__crop-corner--${a} `,style:{top:n,left:r},onMouseDown:l=>{l.preventDefault(),o(l,a)},onClick:l=>{l.preventDefault()}})}}function bo(e){const t=S.createElement("style"),n="#1A141F",r="#302735";return t.textContent=`
.editor {
  padding: 10px;
  padding-top: 65px;
  padding-bottom: 65px;
